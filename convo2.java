...
public class convo2
{
  ...
  public static void main(String[] args)
  {
        ...
        || feeling.equals("Fine") || feeling.equals("fine") || feeling.equals("Great"))
    {
      ...
      {
        System.out.println(
            "Caffeine is the most widely used psychoactive stimulant, targeting the central nervous system and heightening your brain’s feeling of alertness. "
    ...
    if (feeling.equals("Bad"))
    {
      ...
      System.out.println("");
      if (lunch.equals("Yes") || lunch.equals("yes") || lunch.equals("Yea") || lunch.equals("yea"))
      {
